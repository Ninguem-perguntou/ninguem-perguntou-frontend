...
export const About = () => {
  ...
  const authors = useMemo(() => {
    ...
    return authorsData.data?.data.sort((a: any, b: any) => {
      ...
      <Container component="main" maxWidth="lg" sx={{ py: 6, flex: 1 }}>
                ...
                >
                  ...
                  <Box sx={{ textAlign: { xs: "center", sm: "left" } }}>
                    ...
                    {author.about ? (
                      ...
                      >
                        Jornalista dedicado a trazer as notícias mais relevantes
        ...
        >
          ...
          <Typography variant="body1" paragraph sx={{ mb: 3 }}>
            A Agência NINGUÉM PERGUNTOU é um projeto da disciplina de Jornalismo
            Online do Curso de Jornalismo do UDF.
          </Typography>
